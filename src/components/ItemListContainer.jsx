...
export const ItemListContainer =({greeting}) => {
    ...
    useEffect(() =>{
        ...
        if(id){
            getData.then(res => setData(res.filter(item => item.categoria=== id)))
        }else{
